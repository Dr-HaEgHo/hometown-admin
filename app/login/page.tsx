                ...
                <div className="w-full flex flex-col items-center py-[5rem] justify-center gap-[3rem] ">
                    ...
                    <div className='w-[70%] 2xl:w-[80%] max-w-[592px] mx-auto shadow-md p-[40px] 2xl:p-[60px] rounded ' >
                        ...
                        <form className='flex flex-col gap-4 2xl:gap-8' >
                            <Input setValue={setEmail} label="Email" type='email' placeholder='Please enter your email' />
                            <PasswordInput setValue={setPassword} label="Password" placeholder='Please enter your email' />
                            <button type='submit' disabled={ formButtonDisabled } onClick={submitHandler} className="buttons">{ loading === true ? <Loader/> : 'Log in'}</button>
                        </form>
